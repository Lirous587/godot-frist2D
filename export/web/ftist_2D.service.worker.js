...
/** @type {string} */
const CACHE_VERSION = '1756168954|477467096';
/** @type {string} */
const CACHE_PREFIX = 'ftist_2D-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ftist_2D.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ftist_2D.html","ftist_2D.js","ftist_2D.offline.html","ftist_2D.icon.png","ftist_2D.apple-touch-icon.png","ftist_2D.audio.worklet.js","ftist_2D.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["ftist_2D.wasm","ftist_2D.pck"];
